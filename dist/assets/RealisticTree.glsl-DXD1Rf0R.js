import{ib as ta,ka as Q,ay as ra,k9 as ze,kf as ia,hS as Ga,fe as q,aP as z,mf as Da,_ as he,h8 as na,j$ as se,P as c,Q as Me,T as ja,cD as ie,dy as Fa,dC as Ve,dE as Ra,dD as Va,ag as Ba,hN as Ha,jF as Wa,jT as Ua,d9 as qa,b6 as I,eA as Ya,oq as Ja,vU as k,ko as Za,k5 as Be,kk as He,bn as ka,aR as Xa,bd as Ka,eX as Te,fa as Qa,e_ as We,b9 as eo,hV as ao}from"./index-BtjJiBBU.js";import{O as oo}from"./InterleavedLayout-7IsH40KA.js";import{n as w,u as ee,r as Ue,o as Se,t as to,C as ro}from"./ShaderOutput-Bdd80V3g.js";import{n as L,a as M,t as pe}from"./NormalAttribute.glsl-ZH3FdsJb.js";import{aY as io,aZ as no,a_ as j,a$ as so,b0 as lo,b1 as co,a8 as le,b2 as uo,b3 as mo,a1 as ho,ad as po,b4 as vo,g as D,k as ae,_ as V,aq as B,b5 as H,b as K,h as $,as as W,r as fo,e as go,b6 as xo,A as R,b7 as bo,ag as sa,d as la,aa as ca,aW as da,ae as wo,v as _e,x as ve,ac as ua,b8 as Mo,q as ce,aL as To,ah as So,ai as qe,a5 as ye,l as yo,o as E,b9 as p,aK as Ie,a6 as Ee,a7 as de,a2 as Co,ba as No,bb as $o,i as Ae,bc as Oo,c as Eo,bd as ma,$ as ue,be as ha,ar as pa,f as va,a as fa,at as ga,ab as me,bf as xa,K as zo,au as _o,ay as Io,F as Ao,az as Lo,aA as Po,aB as Go,av as Do,aw as jo,ax as Fo,z as Ro,B as G,C as m,D as Vo,E as Ce,aC as Bo,N as Ho,ap as Wo,aU as Uo,aD as qo,O as Yo,W as Jo}from"./OutputColorHighlightOID.glsl-m80t9crd.js";import{i as N,a as Ye,e as oe,n as te}from"./basicInterfaces-N86vRvDz.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{B as Le,g as Pe,f as Zo}from"./renderState-dKgH9pjA.js";import{n as i,t as v}from"./glsl-Cj7KC756.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-3ZHtDHIO.js";import{e as Ge,r as Y}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import"./boundedPlane-CvcNUxNe.js";import"./sphere-DqkRJxgJ.js";function ko(e){e.vertex.code.add(i`
...
}`),s&&n!==R.None&&(e.include(bo,a),t.uniforms.add(l===fe.Pass?new $("normalTexture",(h=>h.textureNormal)):new sa("normalTexture",(h=>h.textureNormal))),d&&(t.uniforms.add(new la("scale",(h=>h.scale??Da))),t.uniforms.add(new j("normalTextureTransformMatrix",(h=>h.normalTextureTransformMatrix??Y)))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
return clamp((x * (2.51 * x + 0.03)) / (x * (2.43 * x + 0.59) + 0.14), 0.0, 1.0);
    ...
    const float GAMMA_SRGB = ${i.float(Ya)};
...
}`)}function St(e,a){a.hasColorTextureTransform?(e.varyings.add("colorUV","vec2"),e.vertex.uniforms.add(new j("colorTextureTransformMatrix",(t=>t.colorTextureTransformMatrix??Y))).code.add(i`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardColorUV(){}`)}function yt(e,a){a.hasNormalTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("normalUV","vec2"),e.vertex.uniforms.add(new j("normalTextureTransformMatrix",(t=>t.normalTextureTransformMatrix??Y))).code.add(i`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardNormalUV(){}`)}function Ct(e,a){a.hasEmissionTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("emissiveUV","vec2"),e.vertex.uniforms.add(new j("emissiveTextureTransformMatrix",(t=>t.emissiveTextureTransformMatrix??Y))).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Nt(e,a){a.hasOcclusionTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("occlusionUV","vec2"),e.vertex.uniforms.add(new j("occlusionTextureTransformMatrix",(t=>t.occlusionTextureTransformMatrix??Y))).code.add(i`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardOcclusionUV(){}`)}function $t(e,a){a.hasMetallicRoughnessTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("metallicRoughnessUV","vec2"),e.vertex.uniforms.add(new j("metallicRoughnessTextureTransformMatrix",(t=>t.metallicRoughnessTextureTransformMatrix??Y))).code.add(i`void forwardMetallicRoughnessUV(){
